			   ...
			   <div class="title-area text-center">
			   		<div class="wow fadeInDown" data-wow-delay="0.4s">
			    		<h2 class="about-title">
			    			<span style="color:#ed1921;">Login.</span>
		                    <span style="color:#0c73bb;">Forum.</span>
		    	...
		    	<div class="about-area">
				   <div class="title-area text-center">
				   		<div class="wow lightSpeedIn" data-wow-delay="0.4s">
				    		<h2 class="about-title">Authentication</h2>
				    	</div>
				  	</div><!-- /.title-area -->
				</div>
				<div class="description">
			  		<div class="wow fadeInUp" data-wow-delay="0.8s">
				  		<p class="text-justify">
				  			Log into your account and have the privillage to be part of
				  			Sapphire Pillars technology discussions, to share information in our
				  			IT community.Know trending and new technologies.
					  	</p>
					</div>
			  	</div>
		    </div>
				...
				<div class="row">
			        <div class="col-sm-5">
			            <form action="#" method="post">
			              	<div class="row">
			              		<!--<div class="wow lightSpeedIn" data-wow-offset="0" data-wow-delay="1.2s">
			              			<h4 class="text-center partner_name">User Login</h4>
			              			<hr class="bold">
			              		</div>-->
				                ...
				                <div class="wow bounceIn" data-wow-offset="0" data-wow-delay="1.8s">
				                	<label class="remember" for="remember"><input id="remember" type="checkbox"> Remember me</label> <br>
			        ...
			        <div class="col-sm-7">
			        	<div class="wow fadeInRight" data-wow-offset="0" data-wow-delay="2.0s">
