			   ...
			   <div class="title-area text-center">
			   		<div class="wow fadeInDown" data-wow-delay="0.4s">
			    		<h2 class="about-title">
			    			<span style="color:#ed1921;">Account.</span>
		    	...
		    	<div class="about-area">
				   <div class="title-area text-center">
				   		<div class="wow lightSpeedIn" data-wow-delay="0.4s">
				    		<h2 class="about-title">Account</h2>
				    	</div>
				  	</div><!-- /.title-area -->
				</div>
				<div class="description">
			  		<div class="wow fadeInUp" data-wow-delay="0.8s">
				  		<p class="text-justify">
					  		Join a group of IT gurus and expets for discussions and gain
					  		knowledge on solution development, system design, running an IT
					  		company, technology ideas and implelementation process and
					  		more topics on Technology.
					  	</p>
					</div>
			  	</div>
		    </div>
			            ...
			            <form action="#" method="post">
			              	<div class="row">
			              		<!--<div class="wow lightSpeedIn" data-wow-offset="0" data-wow-delay="1.2s">
			              			<h4 class="text-center partner_name">User Registration</h4>
			              			<hr class="bold">
			              		</div>-->
