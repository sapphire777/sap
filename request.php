	    		...
	    		<div class="container">
					<section>
						<ul class="clearfix">
							...
							<li class="divider"></li>
							<li class="last">Request Service</li>
						</ul>
					</section>
				</div>
			</div>
		    ...
		    <div class="container">
		    	<div class="about-area">
				   <div class="title-area text-center">
				   		<div class="wow lightSpeedIn" data-wow-delay="0.4s">
				    		<h2 class="about-title">Request a service</h2>
				    	</div>
				  	</div><!-- /.title-area -->
				</div>
				<!--<div class="description">
			  		<div class="wow fadeInUp" data-wow-delay="0.8s">
				  		<p class="text-center">
					  		With its bold, brazen visual style, its elegant and cutting edge Parallax
					  		animations, and smooth CSS3 transitions, ZAP can
					  		churn out professional, businesslike websites
					  		that are <br>bound to capture new business.
					  	</p>
					</div>
			  	</div>-->
			  	<div class="row">
			        <div class="col-sm-6">
			            <form action="bridge/bridge.php" method="post">
			              	<div class="row">
			              	...
			              	<div class="row">
				                <div class="wow bounceIn" data-wow-offset="0" data-wow-delay="1.6s">
				                  	<div class="col-sm-6 form-group">                           
				                    	<label>Tel / Phone Number <span>*</span></label>
			                ...
			                <div class="wow bounceIn" data-wow-offset="0" data-wow-delay="2.0s">
								<div class="form-group">
					                <label>User Story <span>*</span></label>
					                <textarea name="desc" class="form-control" ></textarea>
					            </div> 

					            <button type="submit" class="btn btn-md btn-primary" name="operation"  value="create account">Submit</button>                               
			                </div> 
			        ...
			        <div class="col-sm-6">
			        	<div class="wow fadeInRight" data-wow-offset="0" data-wow-delay="2.4s">
			        		<img class="img-services img-responsive" src="images/lifecycle.jpg">
			        	</div>
			        </div>
			    </div>
		    </div>
