	...
	<head>
  	...
  	<body class="header-fixed-top" id="page-top" data-spy="scroll" data-target=".navbar-custom">
				...
				<div class="description">
			  		<div class="wow fadeInUp" data-wow-delay="0.8s">
				  		<p class="text-justify">
					  		Our technology expertise empowers us to deliver software development services 
			  				and solutions, which ensure your improved business efficiency,increased ROI 
			  				cost-effectiveness, and project risks mitigation.
					  	</p>
					</div>
			  	</div>
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="wow bounceIn" data-wow-delay="1.2s">
							<img class="img-responsive" src="images/java.jpg" alt="Java">
						</div>
					</div>
					<div class="col-sm-2">
						<div class="wow bounceIn" data-wow-delay="1.4s">
							<img class="img-responsive" src="images/dotnet.jpg" alt=".NET">
						</div>
					</div>
					<div class="col-sm-2">
						<div class="wow bounceIn" data-wow-delay="1.6s">
							<img class="img-responsive" src="images/javascript.jpg" alt="Java Script">
						</div>
					</div>
					<div class="col-sm-2">
						<div class="wow bounceIn" data-wow-delay="1.8s">
							<img class="img-responsive" src="images/cplus.jpg" alt="C ++">
						</div>
					</div>
					<div class="col-sm-2">
					...
					<div class="col-sm-2">
						<div class="wow bounceIn" data-wow-delay="2.2s">
							<img class="img-responsive" src="images/python.jpg" alt="Phython">
						</div>
					</div>
				</div>
	    ...
	    <section id="facts" class="facts">
		    <div class="container">
		   		<div class="wow lightSpeedIn" data-wow-delay="0.8s">
		    		<h2 class="about-title text-left">The Right Choice</h2>
		    	</div>

		    	<div class="wow fadeInUp" data-wow-delay="1.6s">
			    	<p class="info">
			    		The choice of technologies for your project implementation is a critical issue that 
			    		influences your project development timeframes and costs. Moreover, technology determines 
			    		how your application will stand the test of time and will be adopted by its end users - be it 
			    		your employees, your customers, or your partners.
			    	</p>
		    	</div>
			</div>
		</section>
